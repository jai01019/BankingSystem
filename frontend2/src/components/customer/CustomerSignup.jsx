...
import { authAPI } from "../../services/api"; // Make sure this path matches where your authAPI is defined
import React from "react";
import { Link } from "react-router-dom";
import { ErrorMessage } from "../common/ErrorMessage";
import { Eye, EyeOff } from "lucide-react";
// src/components/customer/CustomerSignup.jsx
...
const [showPassword, setShowPassword] = useState(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await authAPI.customerSignup(formData);
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-50 z-10">
      <div className="w-full max-w-md mx-auto space-y-8 p-8 bg-white rounded-lg shadow-md relative">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Join SecureBank today</p>
        </div>
