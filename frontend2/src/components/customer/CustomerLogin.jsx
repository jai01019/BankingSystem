// src/components/customer/CustomerLogin.jsx
...
const [showPassword, setShowPassword] = useState(false);
  ...
  return (
    // ADD: Fixed positioning container that overrides any parent styles
    <div className="fixed inset-0 flex items-center justify-center bg-gray-50 z-10">
      {/* ADD: Centered container with explicit positioning */}
